                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 box_tozihat mt-5">
                                    <a href="#" class="mediumtitle">
                        ...
                        <div class="row box-title">
                            ...
                            <div class="boxdetailes row">
                                ...
                                <div class="col-3"><img class="detailicons" src="assets/img/SinglePage_Image/save.svg"
                                        alt=""></div>
                                <div class="col-3"><img class="detailicon" src="assets/img/SinglePage_Image/share.svg"
                                        alt=""></div>
                            </div>
