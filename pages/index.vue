          ...
          <div class="row">
            ...
            <div v-if="error" class="d-flex justify-content-center mt-4">
              ...
              <div v-if="officeShow" class="row content">
                <div v-for="(office, index) in allOffices" :key="index"
                  class="col-sm-12 col-md-6 col-xl-4 descktop-office">
                  <NuxtLink class="link"
                    :to="`office?uid=${office?.uuid}&slug=${filterUrl(office?.title)}&?id=${office?.id}`">
                    <div class="row">
                      ...
                      <div class="col-8">
                        <div class="row">
                          <div class="col-12">
                            <h4 class="descktop-office-title"><img v-if="office.blue_tick"
                                src="assets/img/blue-tick.svg" alt=""> &nbsp; {{ office.title }} </h4>
                          </div>
