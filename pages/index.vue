    ...
    <div class="row" ref="contentBox">
      ...
      <div ref="menuAndMapBox" class="col-sm-3 menu">
        <div ref="menuAndMap" class="row">
          <div class="tab_box">
            ...
            <a @click="showMap = false" class="col-6 tabItem active">
              فیلتر ها
            </a>
          ...
          <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-7">
                      <div class="row">
                        <div class="col-12 margin-fix">
                          <h5 v-if="lastCat !== null" class="category-title">
                            {{ lastCat }}
                          </h5>
                  ...
                  <ul class="categoryBox">
                    <li v-for="(item, index) in categories" :key="index">
                      ...
                      <a
                        @click="getCategory(item.id), setCat(item)"
                        class="link"
                        >{{ item.title }}</a
                      >
                    </li>
                  </ul>
                  <span v-if="emptyCat" class="alert-danger">{{
                    emptyCat
                  }}</span>
                </div>
            ...
            >
              ...
              >
                ...
                <l-circle-marker
                  :lat-lng="[
                    allNotices[1].address.lat,
                    allNotices[1].address.lng,
                  ]"
                  :radius="10"
                  color="red"
                />
                ...
                >
                  <l-popup @ready="ready">
                    <div class="title">
                      <NuxtLink
                        class="link"
                        :href="`notice?id=${notice?.id}&slug=${filterUrl(
                          notice?.title
                        )}`"
                      >
                        {{ notice.title }}
      ...
      <div ref="noticeBox" class="col-sm-9">
        <div class="row category-box-sort">
          ...
          <div class="col-3">
            <div class="row">
              <div class="col-4 disable">
                <img class="pointer" src="~/assets/img/sort1.svg" alt="" />
              </div>
              <div class="col-4 disable">
                <img class="pointer" src="~/assets/img/sort2.svg" alt="" />
              </div>
              <div class="col-4">
                <img class="pointer" src="~/assets/img/sort3.svg" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="noticeShow" class="row" :style="noticeShow ? `display:flex;` : 'display:none;'">
          ...
          <div
            ...
            class="spinner-border-background-index"
          >
            <br />
            <br />
            <br />
        ...
        <div v-if="officeShow" class="row content">
          <div
            ...
            :key="index"
            class="col-sm-12 col-md-6 col-xl-4 descktop-office"
          >
            <NuxtLink
              class="link"
              :to="`office?uid=${office?.uuid}&slug=${filterUrl(
                office?.title
              )}&?id=${office?.id}`"
            >
              <div class="row">
                ...
                <div class="col-8">
                  <div class="row">
                    ...
                    <div class="col-12 mt-3 p-3">
                      <div class="row">
                        <div class="col-9">
                          <h4 class="descktop-office-matter">
                            {{ office?.matter?.title }}
                          </h4>
                        </div>
                        <div class="col-3">
          ...
          <div
            v-if="infinity != null && infinity.fetchingData"
            class="spinner-border-background"
          >
            <br />
            <br />
            در حال بارگیری <br />
