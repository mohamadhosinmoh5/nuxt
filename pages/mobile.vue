  ...
  <div ref="Header_box" class="row ">
    <div class="row mob-nav mt-2">
      ...
      <div class="col-2 text-end">
        ...
        <a v-else disabled><img src="~/assets/img/bagss.svg" style="width: 45px; margin-left: 2px;" alt=""></a>
       ...
       <div class="row search-box">
        ...
        <div class="form-group" style="position:relative;">
          ...
          <input type="text" v-model="textSearch" class="form-control form-style" name="" id=""
            aria-describedby="helpId" placeholder="جست و جو در همه آگهی ها" style="color: #666777;font-size: 14px;text-align: right;
              padding: 6px 35px;">
