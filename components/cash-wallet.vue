    ...
    <div class="row all-boxes">
        <div class="col-sm-10 offset-sm-1 mt-5">
            <div class="row box-wall">
                <div class="col-5">
                    <a class="Title"> کیف پول نقدی : 0تومان</a>
                </div>
                ...
                <UModal v-if="isOpen">
                    <div class="paying row">
                        <div class="col-sm-12">
                            <div class="col">
                                <a class="exit" @click="isOpen = false">
                                    <i class="fa-solid fa-arrow-right"></i>
                                </a>
                                <a class="tile ms-2">افزایش موجودی</a>
                            </div>
                            <div class="border-modal mt-2"></div>
                            <div class="row mt-3">
                                <div class="col-6">
                                    <a @click="changePayiintTab('bank')" class="bank">درگاه بانکی</a>
                                </div>
                                <div class="col-6">
                                    <a @click="changePayiintTab('fish')" class="fish">فیش واریزی</a>
                                </div>
                            </div>
                            <div ref="payiinBorder" class="payiin-border"></div>
                            <div v-if="bank" class="col bank-detailes mt-4">
                                <a class="txtpay">مبلغ مورد نظر را جهت افزودن به کیف پول وارد گنید</a>
                ...
                <UModal v-if="tasfie">
                    <div class="paying row">
                        <div class="col-sm-12">
                            <div class="col">
                                <a class="exit" @click="tasfie = false">
                                    <i class="fa-solid fa-arrow-right"></i>
                                </a>
                                <a class="tile ms-2">درخواست تسفیه</a>
                            </div>
                            <div class="border-modal mt-2"></div>
                            <div class="row mt-3">
                                <div class="col">
                            ...
                            <div v-if="bank" class="col bank-detailes">
                                <a class="txtpay"> حد اکثر تا سه روز کاری مبلغ درخواستی به حساب شبای ثبت شده واریز
                                    خواهد شد. </a>
                                <div class="col-12 forms">
            ...
            <div v-if="setting" class="col-sm-12">
                ...
                <div class="onMobile">
                    ...
                    <div class="text-shaba mt-3">
                        <a>شماره شبا شما که بانک به شما داده است برای مثال : IR234525690123456789011234</a>
                    </div>
                </div>
                ...
                <div class="col multyline">
                    ...
                    <p>در تسفیه هفتگی به صورت خودکار در اول هر هفته حساب شما تسفیه شده و پول به شماره شبا ثبت شده واریز
                        می گردد</p>
                    <p>در تسفیه ماهانه بصورت خودکار در اول هر ماه حساب شما تصفیه شده و پول به شماره شبا ثبت شده واریز می
                        گردد</p>
                    <p>در تصفیه دستی باید مبلغ درخواستی را از بخش درخواست تصفیه ثبت کنید حد اکثر تا سه روز کاری مبلغ
                        درخواستی به حساب شبای ثبت شده واریز خواهد شد</p>
                </div>
            </div>
        </div>
    </div>
