              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group">
                    <input id="my-input" class="form-control" type="text" @input="sectionQuery({field_id:18,type:'numeric',inputName:'Price'})" v-model="minPrice" >
                  </div>
                </div>
                
                <div class="col-6">
                  <div class="form-group">
                    <input id="my-input" class="form-control" type="text" @input="sectionQuery({field_id:18,type:'numeric',inputName:'Price'})" v-model="maxPrice" >
                  </div>
                </div>
              </div>
              <div class="col-sm-12 mt-2">
                <section class="range-slider">
                  <div class="range-input">
                    ...
                    <input type="range" class="max" min="0" max="100000000000" v-model="maxPrice" @input="sectionQuery({field_id:18,type:'numeric',inputName:'Price'})" step="200000000">
                  </div>
                </section>
              ...
              <div class="col-sm-12 mt-2">
                <section class="range-slider">
                  <div class="range-input">
                    ...
                    <input type="range" class="max" min="0" max="500" v-model="maxMetr" @input="sectionQuery({field_id:3,type:'numeric',inputName:'Metr'})" step="10">
                  </div>
                </section>
