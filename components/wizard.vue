<template>
  <div class="container-fluid p-4">
    ...
    <!-- {{ currentStep }} -->
    <!-- <div v-for="(item, index) in wizard.section" :key="index" > -->
    <!-- {{ wizard.section }} -->
    ...
    <div v-if="currentStep == 1">
      ...
      <div v-for="Section in wizard.section[1].field" :key="Section.id" class="adsFilter">
        <div class="form-check">
          <input class="form-check-input" v-model="FormData.future[Section.id]" type="checkbox" value=""
            id="flexCheckDefault">
    ...
    <div v-if="currentStep == 2">
      ...
      <div v-for="Price in wizard.section[2].field" :key="Price.id" class="price">
        <div class="form-group mt-2">
          ...
          {{ FormData.allprice[Price.id] }}
          <input type="email" v-model="FormData.allprice[Price.id]" class="form-control" id="exampleInputEmail1"
    ...
    <div v-if="currentStep == 3">
      ...
      <div v-for="Price in wizard.section[3].field" :key="Price.id" class="price">
        <div class="form-group mt-3">
          <label for="exampleInputEmail1">{{ Price.title }}</label>
          <input type="email" class="form-control" v-model="FormData.detailes[Price.id]" id="exampleInputEmail1"
